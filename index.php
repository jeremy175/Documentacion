    ...
    <div class="page-container">
        ...
        <section class="right-section">
            <div id="content1" class="content">
                ...
                <p>Una plataforma creada con la finalidad de mejorar el proceso de inducción de los nuevos ingresantes UTP, +play busca que el alumno aprenda a través de minijuegos y quizz interactivos.</p>
                <h2>Tecnologías</h2>
                <p>El desarrollo de la plataforma se ha dividido en 3 sectores, a continuación se presentan las herramientas usadas por cada sector respectivamente:</p>
                <ul>
